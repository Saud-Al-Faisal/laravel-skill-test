    ...
    <div class="card-header ">
     ...
     <div class="card-body">
        ...
        <div class="designations">
            @include('users.designations.designation-table')
        </div>
...
<script>
    ...
    $(document).on('click', '#add', function(){
        var designation_name = $('#designation_name').text().trim();
        if(designation_name != '')
        {
        $.ajax({
            url:"{{route('designation.insert')}}",
            method:"POST",
            data:{designation_name:designation_name, _token:_CSRF_TOKEN},
                ...
                if(data[0]==1){
                 ...
                 $('#add_row').after(`
                        <tr>
                            ...
                            <td>${data[2].id}</td>
                            <td contenteditable class="column_name" data-column_name="designation_name" data-id="${data[2].id}">${data[2].designation_name}</td>
                            <td> 
        ...
        $('#message').html("<div class='alert alert-danger'>Designation Name Field is required</div>");
        }
        });
        ...
        $(document).on("change","input.select_checkbox", function(e) {
            ...
            var checked_items_key = 'checked-designation-rows';
